...
class SortPager{
    ...
    public function showPagination(){
        ...
        if($this->_currentPage > 1){
                ...
                $start = "<li><a value='1'>".'Start'."</a></li>";
                
                $prev = "<li><a value='".($this->_currentPage-1)."' class='prev'>".'«'."</a></li>";
        }
        ...
        if($this->_currentPage < $this->_totalPage){
                ...
                $next = "<li><a value='".($this->_currentPage+1)."' class='next'>".'»'."</a></li>";
                $end = "<li><a value='".($this->_totalPage)."'>".'end'."</a></li>";
		}
